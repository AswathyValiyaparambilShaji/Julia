...
println("\nCalculating derived terms...")
    ...
    Residual  = -(Conv .- TotalFlux .- ET_full)
    ...
    Colorbar(fig[1:2, 4], hm7, label = "[W/m2]")
    ...
    # Save figure
    FIGDIR = cfg["fig_base"]
    save(joinpath(FIGDIR, "EnergyBudget_CCDE_nt_V1.png"), fig)

println("\nFigure saved: $(joinpath(FIGDIR, "EnergyBudget_CCDE_nt_V1.png"))")
