...
if time_mode == "3day"
    ...
    mkpath(joinpath(base2, "Conv_3day_corr"))
    ...
    for xn in cfg["xn_start"]:cfg["xn_end"]
        ...
        pp = nothing; p_eta = nothing; GC.gc()
            ...
            open(joinpath(base2, "Conv_3day_corr", "Conv_3day_$suffix2.bin"), "w") do io
...
elseif time_mode == "weekly"
    ...
    mkpath(joinpath(base2, "Conv_weekly_corr"))
    ...
    for xn in cfg["xn_start"]:cfg["xn_end"]
        ...
        pp = nothing; p_eta = nothing; GC.gc()
            ...
            suffix2 = @sprintf("%02dx%02d_%d", xn, yn, buf-2)
            open(joinpath(base2, "Conv_weekly_corr", "Conv_weekly_$suffix2.bin"), "w") do io
                write(io, Float32.(ca))
            end
...
elseif time_mode == "full"
    ...
    mkpath(joinpath(base2, "Conv_corr"))
    ...
    for xn in cfg["xn_start"]:cfg["xn_end"]
        ...
        pp = nothing; p_eta = nothing; GC.gc()
            ...
            suffix2 = @sprintf("%02dx%02d_%d", xn, yn, buf-2)
            open(joinpath(base2, "Conv_corr", "Conv_$suffix2.bin"), "w") do io
                write(io, Float32.(ca))
            end
