...
ncfile = joinpath(mydir, "Moorings_88_combined.nc")  # <-- new combined file from build_mooring_netcdf_v2.jl
...
DRF = Array(ds["DRF"])   # now stored directly in the combined file -- no delR.bin needed
...
hFacC = Float64.(Array(ds["hFacC"]))   # (station, depth) -- 0/1 mask aliased from 'wet' in the combined file
...
# ============================================================================
# PLOT: mode 1 and mode 2 flux vectors at every mooring location.
# ============================================================================
