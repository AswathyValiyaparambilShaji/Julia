...
JOB4=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/NT/Shear_pdh_Plot_nt.jl -W depend=afterok:$JOB3 $PBS)
echo "Job 4 submitted: $JOB4"

JOB5=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/NT/Buoyancy_pd_Plot_nt.jl  -W depend=afterok:$JOB4 $PBS)
echo "Job 5 submitted: $JOB5"

JOB6=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/NT/ADV_KE_Plot_nt.jl -W depend=afterok:$JOB5 $PBS)
echo "Job 6 submitted: $JOB6"

JOB7=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/NT/Shear_pdv_Plot_nt.jl -W depend=afterok:$JOB6 $PBS)
...
JOB8=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/NT/APE_Plot_nt.jl -W depend=afterok:$JOB7 $PBS)
