...
JOB4=$(qsub -v JULIA_SCRIPT=$BASE/Box28/NT/Ke_b_nt.jl -W depend=afterok:$JOB3 $PBS)
...
JOB7=$(qsub -v JULIA_SCRIPT=$BASE/Box28/NT/ADV_PE_nt.jl -W depend=afterok:$JOB6 $PBS)
...
JOB9=$(qsub -v JULIA_SCRIPT=$BASE/Box28/NT/Shear_pdh_nt.jl -W depend=afterok:$JOB8 $PBS)
echo "Job 9 submitted: $JOB9"

JOB10=$(qsub -v JULIA_SCRIPT=$BASE/Box28/NT/Shear_pdv_nt.jl -W depend=afterok:$JOB9 $PBS)
echo "Job 10 submitted: $JOB10"

JOB11=$(qsub -v JULIA_SCRIPT=$BASE/Box28/NT/Windinput_nt.jl  $PBS)
