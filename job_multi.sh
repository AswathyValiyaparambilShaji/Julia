...
JOB5=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Bouyancy_pd_nt.jl  -W depend=afterok:$JOB4 $PBS)
...
JOB7=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Shear_pdh_nt.jl -W depend=afterok:$JOB6 $PBS)
...
JOB9=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Shear_pdv_nt.jl -W depend=afterok:$JOB8 $PBS)
...
JOB11=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Tendency_term_nt.jl -W depend=afterok:$JOB10 $PBS)
