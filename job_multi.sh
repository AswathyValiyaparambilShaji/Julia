...
JOB1=$(qsub -v JULIA_SCRIPT=$BASE/NT/Conversion_nt.jl  $PBS)
...
JOB3=$(qsub -v JULIA_SCRIPT=$BASE/NT/Conv_plot_nt.jl  -W depend=afterok:$JOB1 $PBS)
...
JOB5=$(qsub -v JULIA_SCRIPT=$BASE/NIW/Shear_pdh_niw.jl  -W depend=afterok:$JOB3 $PBS)
echo "Job 5 submitted: $JOB5"

JOB6=$(qsub -v JULIA_SCRIPT=$BASE/NIW/Shear_pdv_niw.jl -W depend=afterok:$JOB5 $PBS)
...
JOB9=$(qsub -v JULIA_SCRIPT=$BASE/SM/Energy_line_plot3.jl -W depend=afterok:$JOB6 $PBS)
