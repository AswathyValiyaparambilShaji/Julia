...
JOB12=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NIW/buoyancy_pd_niw.jl -W depend=afterok:$JOB11 $PBS)
echo "Job 12 submitted: $JOB12"

JOB13=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NIW/Shear_pdv_niw.jl -W depend=afterok:$JOB12 $PBS)
