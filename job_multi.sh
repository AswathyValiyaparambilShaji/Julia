...
#JOB3=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/3day_mean/Mean_UV.jl -W depend=afterok:$JOB2 $PBS)
...
JOB14=$(qsub -v JULIA_SCRIPT=$BASE/Box27b/NT/Perturbation_nt.jl $PBS -w depend=afterok:$JOB2 $PBS)
