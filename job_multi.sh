...
JOB4=$(qsub -v JULIA_SCRIPT=$BASE/SM/Shear_pdh_plot_nt.jl  -W depend=afterok:$JOB3 $PBS)
...
JOB6=$(qsub -v JULIA_SCRIPT=$BASE/SM/ADV_PE_sm_bc.jl -W depend=afterok:$JOB5 $PBS)
...
JOB10=$(qsub -v JULIA_SCRIPT=$BASE/SM/ADV_PE_sm_plot.jl -W depend=afterok:$JOB9 $PBS)
