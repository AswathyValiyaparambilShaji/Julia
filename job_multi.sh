...
JOB1=$(qsub -v JULIA_SCRIPT=$BASE/Budget/SM/eigen_velocities_m2.jl  $PBS)
echo "Job 1 submitted: $JOB1"

JOB2=$(qsub -v JULIA_SCRIPT=$BASE/Budget/SM/modal_projection.jl  -W depend=afterok:$JOB1 $PBS)
...
#JOB5=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Bouyancy_pd_nt.jl  -W depend=afterok:$JOB3 $PBS)
...
#JOB7=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Shear_pdh_nt.jl -W depend=afterok:$JOB5 $PBS)
...
#JOB9=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Shear_pdv_nt.jl -W depend=afterok:$JOB7 $PBS)
...
#JOB11=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Tendency_term_nt.jl -W depend=afterok:$JOB9 $PBS)
#echo "Job 11 submitted: $JOB11"

#JOB12=$(qsub -v JULIA_SCRIPT=$BASE/Budget/NT/Conversion_nt.jl -W depend=afterok:$JOB11 $PBS)
