...
JOB3=$(qsub -v JULIA_SCRIPT=$BASE/NIW/Shear_pdh_niw.jl -W depend=afterok:$JOB2 $PBS)
echo "Job 3 submitted: $JOB3"

JOB4=$(qsub -v JULIA_SCRIPT=$BASE/NIW/Shear_pdv_niw.jl -W depend=afterok:$JOB3 $PBS)
