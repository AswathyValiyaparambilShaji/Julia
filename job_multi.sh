...
JOB1=$(qsub -v JULIA_SCRIPT=$BASE/SM/Energy_line_plot3.jl  $PBS)
...
JOB3=$(qsub -v JULIA_SCRIPT=$BASE/NT/APE_plot_nt.jl  -W depend=afterok:$JOB2 $PBS)
echo "Job 3 submitted: $JOB3"

JOB4=$(qsub -v JULIA_SCRIPT=$BASE/NT/ADV_KE_nt_plot.jl  -W depend=afterok:$JOB3 $PBS)
...
JOB6=$(qsub -v JULIA_SCRIPT=$BASE/NT/Shear_pdh_nt_plot.jl -W depend=afterok:$JOB5 $PBS)
echo "Job 6 submitted: $JOB6"

JOB7=$(qsub -v JULIA_SCRIPT=$BASE/NT/Shear_pdv_nt_plot.jl -W depend=afterok:$JOB6 $PBS)
